...
class _AuthPageWidgetState extends State<AuthPageWidget> {
  ...
  void initState() {
    super.initState();
    confirmPasswordCreateController = TextEditingController();
            ...
            children: [
              Padding(
                ...
                child: Row(
                  ...
                  children: [
                    Image.network(
                      'https://i.postimg.cc/Jn6wyDTy/oie-transparent.png',
                      height: 100,
                      fit: BoxFit.cover,
                    ),
                  ],
                                ...
                                children: [
                                  ...
                                  Padding(
                                    ...
                                    child: FFButtonWidget(
                                      onPressed: () async {
                                        logFirebaseEvent(
                                            'AUTH_PAGE_PAGE_Button-Login_ON_TAP');
                                        logFirebaseEvent(
                                    ...
                                    child: Row(
                                      ...
                                      children: [
                                        Padding(
                                          ...
                                          child: Text(
                                            FFLocalizations.of(context).getText(
                                              'mr25vzeu' /* Ou use sua rede social para en... */,
                                            ),
                                            style: FlutterFlowTheme.of(context)
                                                .bodyText1
                                                .override(
                                    ...
                                    child: Row(
                                      ...
                                      children: [
                                        InkWell(
                                          onTap: () async {
                                            logFirebaseEvent(
                                                'AUTH_PAGE_PAGE_Container_8d2sro4y_ON_TAP');
                                        ...
                                        InkWell(
                                          onTap: () async {
                                            logFirebaseEvent(
                                                'AUTH_PAGE_PAGE_Container_jrrubaq0_ON_TAP');
                                            logFirebaseEvent('Container_auth');
                                            GoRouter.of(context)
                                                .prepareAuthEvent();
                                            final user =
                                ...
                                children: [
                                  ...
                                  Padding(
                                    ...
                                    child: FFButtonWidget(
                                      onPressed: () async {
                                        logFirebaseEvent(
                                            'AUTH_PAGE_PAGE_Button-signup_ON_TAP');
                                        logFirebaseEvent(
                                            'Button-signup_backend_call');
                                        await AuthCreateCall.call(
                                    ...
                                    child: Row(
                                      ...
                                      children: [
                                        Padding(
                                          ...
                                          child: Text(
                                            FFLocalizations.of(context).getText(
                                              't1tirgsw' /* Crie uma conta com sua rede so... */,
                                            ),
                                            style: FlutterFlowTheme.of(context)
                                                .bodyText1
                                                .override(
                                    ...
                                    child: Row(
                                      ...
                                      children: [
                                        InkWell(
                                          onTap: () async {
                                            logFirebaseEvent(
                                                'AUTH_PAGE_PAGE_Container_ox084rtg_ON_TAP');
                                            logFirebaseEvent('Container_auth');
                                            GoRouter.of(context)
                                                .prepareAuthEvent();
                                            final user =
                                        ...
                                        InkWell(
                                          onTap: () async {
                                            logFirebaseEvent(
                                                'AUTH_PAGE_PAGE_Container_3bike6f4_ON_TAP');
                                            logFirebaseEvent('Container_auth');
                                            GoRouter.of(context)
                                                .prepareAuthEvent();
                                            final user =
