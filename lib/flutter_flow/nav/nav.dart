...
class AppStateNotifier extends ChangeNotifier {
  CuidamosFirebaseUser? initialUser;
  CuidamosFirebaseUser? user;
  ...
  void update(CuidamosFirebaseUser newUser) {
    initialUser ??= newUser;
    user = newUser;
...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      errorBuilder: (context, _) =>
          appStateNotifier.loggedIn ? HomeDashWidget() : AuthPageWidget(),
      routes: [
        FFRoute(
          name: '_initialize',
          path: '/',
          ...
          routes: [
            ...
            FFRoute(
              ...
              path: 'phoneScreen',
              requireAuth: true,
              builder: (context, params) => PhoneScreenWidget(),
            ),
            FFRoute(
              name: 'user_info',
              path: 'userInfo',
